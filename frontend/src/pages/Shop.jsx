        ...
        <div className='min-h-screen bg-gray-50'>
            ...
            {shop && <div className='relative w-full h-64 md:h-80 lg:h-96'>
                ...
                <div className='absolute inset-0 bg-gradient-to-b from-black/70 to-black/30 flex flex-col justify-center items-center text-center px-4'>
                    ...
                    <h1 className='text-3xl md:text-4xl font-extrabold text-white drop-shadow-lg'>{shop.name}</h1>
            ...
            <div className='max-w-7xl mx-auto px-6 py-10'>
                <h2 className='flex items-center justify-center gap-3 text-2xl md:text-3xl font-bold mb-10 text-gray-800'><FaUtensils color='red' /> Our Menu</h2>
